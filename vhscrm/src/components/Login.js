  ...
  return (
    <div >
      ...
      >
        <div className="row">
        <div className="col-6">
          <img src="loginhead.png" style={{width:"100%",height:"150px"}}/>
        </div>
        <div className="col-6">
        ...
        <div className="col-10" style={{ marginTop: "5%" }}>
            ...
            <div style={{ display: "flex" }}>
              ...
              <Card style={{ boxShadow: "0px 0px 5px 1px lightgray",backgroundColor: "rgb(232, 232, 232)",padding:80}} >
              <div >
                <div
                  style={{
                  textAlign:"center",
            ...
            <h4 className="mt-3">LOGIN TO YOUR ACCOUNT</h4>
                ...
                <p style={{fontSize:"12px",marginTop:"10px",textAlign:"center"}}><b>Never share your login details with anyone.</b></p>
